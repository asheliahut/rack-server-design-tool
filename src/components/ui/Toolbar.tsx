  ...
  return (
    <div ref={toolbarRef} className="relative">
      ...
      <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1 overflow-hidden">
        ...
        {/* Design name editor - Visible on all screen sizes */}
        <div className="flex items-center min-w-0 flex-1 sm:flex-none ml-3 sm:ml-0">
          {isEditingName ? (
            <div className="flex items-center bg-blue-50 dark:bg-blue-900/30 rounded-md p-1 flex-1 sm:flex-none">
              <input
                ...
                className="px-2 py-1 border border-blue-300 dark:border-blue-500 rounded text-sm font-medium bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 min-w-0 flex-1 sm:w-auto"
                autoFocus
              />
            </div>
          ) : (
            <div className="flex items-center bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors cursor-pointer group flex-1 sm:flex-none" onClick={handleNameEdit}>
              <span className="text-xs sm:text-sm font-medium text-gray-900 dark:text-gray-100 truncate min-w-0 flex-1 sm:max-w-44" title={`Click to edit: ${designName}`}>
                {designName}
              </span>
              <Button
                variant="ghost"
                ...
                className="p-0.5 ml-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 flex-shrink-0 transition-colors"
